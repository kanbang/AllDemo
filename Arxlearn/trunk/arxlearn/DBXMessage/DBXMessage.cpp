...
//-----------------------------------------------------------------------------
//- DBXMessage.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
#include <afxdllx.h>
...
AC_IMPLEMENT_EXTENSION_MODULE(DBXMessageDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE DBXMessageExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		DBXMessageDLL.AttachInstance (hInstance) ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		DBXMessageDLL.DetachInstance () ;
	}
	return (TRUE) ;
}
